/**
 * k6 Lasttest: Normal Traffic Simulation
 * 
...
export default function (data: any) {
  ...
  userJourneyNormal(baseUrl, session);
}

/**
 * Simuliert normalen Benutzer-Journey mit realistischen Delays
 */
function userJourneyNormal(baseUrl: string, session: Session) {
  const user = generateUser('normal');
